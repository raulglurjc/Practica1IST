...
public class Director {
	...
	public Director(String nombre, String apellidos, String pseudonimo, LocalDate fecha_nacimiento, int participaciones,
			boolean activo, List<String> premios, LocalDate fecha_muerte) {
